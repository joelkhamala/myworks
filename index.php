...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 {
include "userAccount/connect.php";
$qry= "SELECT * FROM tblusers WHERE username= '$inputuname' AND password='$inputPwd'";
  ...
  if($count>0)
  {
    ...
    header("Location: userAccount/homepage.php");
  }
  else
  {
        ...
        <div class="row ">
            <div class="col-md-4 py-5 bg-primary text-white text-center ">
              <h2 class="py-3">VPMS Online Platform</h2>
                <div class=" ">
                    <div class="card-body">
                        <img src="userAccount/registration_bg.svg" style="width:30%">
            ...
            <div class="col-md-8 py-5 border">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                    ...
                    <div class="form-row">
                        <button type="reset" class="btn btn-danger">Clear Details</button>&nbsp
                        <button type="submit" class="btn btn-success" onclick="return validate()">Login</button>&nbsp
                        <a href="userAccount/registration.php" class="btn btn-info">Register</a> &nbsp
