   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="catename" id="catename" class="form-control">
                                                ...
                                                <?php
                                                $qury=mysqli_query($con,"select * from tblcategory");
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select id="ownername" name="ownername" class="form-control">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select id="ownercontno" name="ownercontno" class="form-control">
                                                <option>--Select User Phone--</option>
                                                <?php
                                                $rows=mysqli_fetch_array($query);
                                                foreach($rows as $rowphone)
                                                  {
                                                  ?>    
                                                    <option value="<?php echo $rowphone['phone'];?>"><?php echo $rowphone['phone'];?></option>
                                                <?php
                                                }
                                                ?> 
                                            </select>
